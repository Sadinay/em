...
源码：[../update.py](../../models/vgg16/update.py)；冻结配置：[../config.json](../../models/vgg16/config.json)；数据来源和隔离：[../audit/data_audit.json](../audit/data_audit.json)；GPU/恢复检查：[../audit/preflight.json](../audit/preflight.json)。每组runs下保存日志、验证预测、检查点和哈希。
