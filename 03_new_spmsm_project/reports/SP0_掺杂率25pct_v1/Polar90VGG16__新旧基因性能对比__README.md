...
- [平均转矩：真实值与预测值](<Polar90VGG16__新旧基因性能对比__01_平均转矩_真实值与预测值.png>)
- [转矩波动：真实值与预测值](<Polar90VGG16__新旧基因性能对比__02_转矩波动_真实值与预测值.png>)
- [相对训练前 f0 的 MAE 变化](<Polar90VGG16__新旧基因性能对比__03_新旧基因_MAE变化.png>)
- [仅新基因：老模型与更新模型叠加对比](<Polar90VGG16__新旧基因性能对比__04_仅新基因_老模型与更新模型对比.png>)：蓝色为老模型，橙色为更新模型；两行分别为平均转矩、转矩波动，两列分别为 G-S、F-S。
- [完整数值](<Polar90VGG16__新旧基因性能对比__性能指标.csv>)，物理单位均为 N·m；图像仅保存 PNG。
...
源代码集中在 [../diagnostics.py](<../../experiments/cnn_replay_update_v1/report/diagnostics.py>)。从仓库根目录 `em` 重新出图：
